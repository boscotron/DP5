...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_highcharts_highcharts_more__ = __webpack_require__(385);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_highcharts_solid_gauge__ = __webpack_require__(386);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_highcharts_solid_gauge___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_highcharts_solid_gauge__);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
__WEBPACK_IMPORTED_MODULE_4_highcharts_solid_gauge__(__WEBPACK_IMPORTED_MODULE_2_HighCharts__);
var AboutPage = (function () {
    ...
    AboutPage.prototype.ver = function () {
        __WEBPACK_IMPORTED_MODULE_2_HighCharts__["chart"]('plop', {
            chart: {
                type: 'solidgauge',
                marginTop: 50
            },
            ...
            pane: {
                ...
                background: [{
                        outerRadius: '112%',
                        innerRadius: '100%',
                        backgroundColor: __WEBPACK_IMPORTED_MODULE_2_HighCharts__["Color"](__WEBPACK_IMPORTED_MODULE_2_HighCharts__["getOptions"]().colors[0])
                            .setOpacity(0.3)
                            .get(),
                        borderWidth: 0
                    }, {
                        outerRadius: '99%',
                        innerRadius: '90%',
                        backgroundColor: __WEBPACK_IMPORTED_MODULE_2_HighCharts__["Color"](__WEBPACK_IMPORTED_MODULE_2_HighCharts__["getOptions"]().colors[1])
                            .setOpacity(0.3)
                            .get(),
                        borderWidth: 0
                    }, {
                        outerRadius: '89%',
                        innerRadius: '80%',
                        backgroundColor: __WEBPACK_IMPORTED_MODULE_2_HighCharts__["Color"](__WEBPACK_IMPORTED_MODULE_2_HighCharts__["getOptions"]().colors[2])
                            .setOpacity(0.3)
                            .get(),
                        borderWidth: 0
                    }, {
                        outerRadius: '79%',
                        innerRadius: '70%',
                        backgroundColor: __WEBPACK_IMPORTED_MODULE_2_HighCharts__["Color"](__WEBPACK_IMPORTED_MODULE_2_HighCharts__["getOptions"]().colors[3])
                            .setOpacity(0.3)
                            .get(),
                        borderWidth: 0
                    }, {
                        outerRadius: '69%',
                        innerRadius: '60%',
                        backgroundColor: __WEBPACK_IMPORTED_MODULE_2_HighCharts__["Color"](__WEBPACK_IMPORTED_MODULE_2_HighCharts__["getOptions"]().colors[4])
                            .setOpacity(0.3)
                            .get(),
                        borderWidth: 0
                    }]
            ...
            series: [{
                    ...
                    data: [{
                            color: __WEBPACK_IMPORTED_MODULE_2_HighCharts__["getOptions"]().colors[0],
                            bsktiempo: '17 días',
                            //    radius: '112%',
                            //    innerRadius: '100%',
                            y: 82
                    ...
                    name: 'Presentación',
                    data: [{
                            color: __WEBPACK_IMPORTED_MODULE_2_HighCharts__["getOptions"]().colors[1],
                            bsktiempo: '17 días',
                            //   radius: '99%',
                            //   innerRadius: '90%',
                            y: 78
                    ...
                    data: [{
                            color: __WEBPACK_IMPORTED_MODULE_2_HighCharts__["getOptions"]().colors[2],
                            bsktiempo: '17 días',
                            //  radius: '89%',
                            //  innerRadius: '80%',
                            y: 55
                    ...
                    name: 'Playita 2018',
                    data: [{
                            color: __WEBPACK_IMPORTED_MODULE_2_HighCharts__["getOptions"]().colors[3],
                            bsktiempo: '17 días',
                            //  radius: '79%',
                            //  innerRadius: '70%',
                            y: 50
                    ...
                    name: 'Carnaval',
                    data: [{
                            color: __WEBPACK_IMPORTED_MODULE_2_HighCharts__["getOptions"]().colors[4],
                            bsktiempo: '17 días',
                            // radius: '69%',
                            // innerRadius: '60%',
                            y: 35
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_jmydb__ = __webpack_require__(413);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23_angular2_moment__ = __webpack_require__(414);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24_angular_linky__ = __webpack_require__(419);
